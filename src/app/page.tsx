...
const HeroSection = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-[#FAF4F4] py-4 px-2">
  <div className="flex flex-wrap justify-center gap-4">
    ...
    <div className="flex flex-col items-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
      ...
      />
      <h3 className="text-xl font-bold mt-2">Side Table</h3>
      <button className="underline hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded mt-2">
        View More
      </button>
    </div>
    {/* Item 2 */}
    <div className="flex flex-col items-center w-full sm:w-1/4 md:w-1/3 lg:w-1/4">
      <Image
        src="/s1.jpg"
        width={350}
        height={300}
